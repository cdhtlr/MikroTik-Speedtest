...
- <b>24MB of disk space left</b> (6MB for compressed TAR image, 16MB for uncompressed running image. You can delete the compressed TAR image once the image is successfully decompressed)
