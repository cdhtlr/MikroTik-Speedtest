...
- <b>27MB of disk space remaining</b> (9MB for compressed TAR image, 18MB for uncompressed running image)
- <b>6MB of RAM space remaining</b> (could be more, depending on the workload)
